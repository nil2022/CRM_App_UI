        ...
        return (
            <div className="flex flex-col h-[100vh]">
                ...
                {authData.userType === "ADMIN" && (
                    <p className="text-3xl text-center p-2">
                        Hi, {authData?.fullName}
                    </p>
                )}
                {renderCount > 0 && (
                    <p className="m-4 p-2">
                        Render Count in Dashboard.jsx :{renderCount}
                    </p>
                )}
                    ...
                    <div className="h-[70vh] ">
                        ...
                        <div className="hidden sm:block text-xl font-[500] m-5">
                            <div className="p-4">
                                ...
                                <p className="text-xs max-w-[250px] overflow-hidden">
                                    {userData?._id || "id"}
                                </p>
                ...
                {error && (
                    <p className="text-red-500 text-center font-semibold text-lg mt-2">
                        {error}
                    </p>
                )}
                {/* ****************************ACTUAL CODE ************************************* */}
